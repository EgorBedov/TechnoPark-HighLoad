...
Таким образом, мы можем уместить всю базу в оперативной памяти одной машины с RAM = 64GB, поэтому мы заведём 4 сервера по модели master-slave с алгоритмом балансировки round-robin. Один инстанс Redis-а может выдерживать от 60к до 80к RPS [benchmarks](https://redis.io/topics/benchmarks).
...
Требуемое количество машин = 70 / 32 = 2.19
Для надёжности возьмём на три машины больше
