...
Хранить сессии активных пользователей лучше всего в высокопроизводительной БД, которая стоит перед бекендом и снимает долю нагрузки с него.
Возьмём [Redis](https://eax.me/redis/), поскольку он удовлетворяет нашим потребностям по функционалу, лучше своего конкурента Memcached и способен выдерживать заданную нагрузку [benchmark](https://redis.io/topics/benchmarks). 
